...
+(void)createAlertViewWithFrame:(NSString *)Msg Target:(id)target{
    UIAlertView *promptAlert = [[UIAlertView alloc] initWithTitle:@"提示" message:Msg delegate:target cancelButtonTitle:nil otherButtonTitles:nil];
